...
<section class="k_list k_upcoming " id="media">
	<div class="menu">
		<ul>
			<li class="all"><a class="active" href="#" >ENGLISH <img src="<?php echo bloginfo('template_directory');?>/assets/img/element-navpointer.png"></a></li>
			<li class="up"><a class=" " href="<?php echo bloginfo('url');?>/kathas/media-gujarati/">GUJARATI <img src="<?php echo bloginfo('template_directory');?>/assets/img/element-navpointer.png"></a></li>
			<!-- <li class="up"><a class=" " href="#">Hindi <img src="<?php echo bloginfo('template_directory');?>/assets/img/element-navpointer.png"></a></li> -->
		</ul>
	</div>
			...
			<div class="up_wrapper">
                ...
                <div class="col-md-12 item_wrap">
					...
					<div class="item">
						...
						<div class="desc">
							<a href="<?php the_sub_field('news_url'); ?>" class="aright" target="_blank"><i class="fa fa-angle-right"></i></a>
