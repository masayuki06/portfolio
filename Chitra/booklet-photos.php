<?php /* Template Name: Contact Booklet and Photos */ ?>
<?php get_header(); ?>
...
<section class="k_list cstm_contact c_bp" id="contact">
	<div class="menu">
		<div class="container">
			<ul>
				...
				<li class="book"><a class="active" href="<?php echo bloginfo('url');?>/contact-us/katha-booklets-photos/">Katha Booklets and Photos <img src="<?php echo bloginfo('template_directory');?>/assets/img/element-navpointer.png"></a></li>
			</ul>
		</div>
	</div>
	...
	<div class="c_details">
		<div class="bg" style="background:url('<?php echo get_the_post_thumbnail_url(); ?>')no-repeat;">
			<div class="container">
				<div class="desc">
					<h4>Katha Booklets and Photos</h4>
                    <p> <!-- <?php echo (get_field('address') != '' ? get_field('address') : ''); ?> -->
